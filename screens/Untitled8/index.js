...
const Untitled8 = () => {
  return <View style={_styles.juiNgyDg}>
      <ImageBackground style={_styles.XMHZpDVF} source={{
    ...
    }} resizeMode="cover"></ImageBackground><Text style={_styles.gwbDrlnZ}>The user name and password does not match our records. Please try again</Text><Text style={_styles.gkpbVbRd}>Login</Text><TextInput style={_styles.NsMPCfWl}></TextInput><View style={_styles.dEarzJyW}></View></View>;
};
...
const _styles = StyleSheet.create({
  ...
  gkpbVbRd: {
    left: 84.23787936644923,
    top: 199.10771486615275,
    position: "absolute",
    width: 100,
    height: 50,
    lineHeight: 14,
  ...
  dEarzJyW: {
    left: 114.8698354997035,
    top: 496.23768935871914,
    position: "absolute",
    height: 60,
    width: 140,
    backgroundColor: "#203DD6",
    borderRadius: 3,
    color: "#777777"
  }
});