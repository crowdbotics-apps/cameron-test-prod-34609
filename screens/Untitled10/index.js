...
const Untitled10 = () => {
  return <View style={_styles.DrQhzTTu}>
      <ImageBackground style={_styles.AOwbjSaH} source={{
    ...
    }} resizeMode="cover"></ImageBackground><TextInput style={_styles.DjLOFaGj}></TextInput><View style={_styles.qWxPEtTL}></View><Text style={_styles.yocqDPYz}>Login</Text></View>;
};
